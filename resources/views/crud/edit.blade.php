        ...
        <div class="card">
          <div class="card-body">
                ...
                <form action="{{ route('crud.update',$crud->id) }}" method="POST">
                    ...
                    <input type="text" class="form-control" name="nis" value="{{ $crud->nis }}" id="nis">
                    </div>
                    <div class="mb-3">
                        <label for="nama" class="form-label">Nama</label>
                        <input type="text" class="form-control" name="nama" value="{{ $crud->nama }}" id="nama">
                    </div>
                    <div class="mb-3">
                        <label for="jurusan" class="form-label">Jabatan</label>
                        <input type="text" class="form-control" name="jurusan" value="{{ $crud->jurusan }}" id="jurusan">
                    </div>
                    <div class="mb-3">
                      <label for="departemen" class="form-label">departemen</label>
                      <input type="text" class="form-control" name="departemen" value="{{ $crud->departemen }}" id="departemen">
                  </div>
                  <div class="mb-3">
                    <label for="tempat_lahir" class="form-label">tempat_lahir</label>
                    <input type="text" class="form-control" name="tempat_lahir" value="{{ $crud->tempat_lahir }}" id="tempat_lahir">
                  </div>

                    <div class="mb-3">
                      <label for="alamat" class="form-label">No.hp</label>
                      <input type="text" class="form-control" name="alamat" value="{{ $crud->alamat }}" id="alamat">
                  </div>
                  <div class="mb-3">
                    <label for="tgl_lahir" class="form-label">Tanggal Lahir</label>
                    <input type="date" class="form-control" name="tgl_lahir" value="{{ $crud->tgl_lahir }}" id="tgl_lahir">
                  </div>
